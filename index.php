...
<body>
    ...
    <div class="col s12 m8 offset-m2 l6 offset-l3">
        <form class="col s12" action="<?php echo 'calculos1.php?N='.$N.'&Y='.$Y.'&X='.$X.'&Probabilidad='.$probabilidad.''; //echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="card-panel pink lighten-4">
                ...
                <div class="card-panel pink lighten-5 z-depth-1">
                    <div class="row valign-wrapper">
                        <div class="col s2">
                            <img src="img/Integral.png" alt="" class="responsive-img"> <!-- notice the "circle" class -->
                        </div>
                ...
                <button class="btn waves-effect waves-light white black-text" type="submit" name="action">Probar</button>
            </div>
        </form>  
    </div>
